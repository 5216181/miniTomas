...
Blockly.Arduino.setups_["print_attachInterrupt"+value_e3.toString()]='attachInterrupt('+value_e3.toString()+','+value_e1.substr(1,value_e1.length-2)+', CHANGE);\n';
...
return 'attachInterrupt('+value_e3.toString()+', encoder_ISR, CHANGE);\n';
};
